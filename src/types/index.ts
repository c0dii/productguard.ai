...
export interface AIExtractedData {
  ...
  // Semantic Keyword Engine (optional — generated by piracy-keyword-generator)
  piracy_search_terms?: string[]; // Product-specific piracy search queries
  auto_alternative_names?: string[]; // Auto-detected abbreviations, misspellings, slug forms
  auto_unique_identifiers?: string[]; // Auto-extracted file names, version numbers, serial patterns
  platform_search_terms?: Record<string, string[]>; // Platform-optimized terms: { google, telegram, torrent, forum, cyberlocker }
  piracy_analysis_metadata?: ExtractionMetadata; // Metadata for the piracy keyword AI call
}
