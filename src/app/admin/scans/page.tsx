  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-pg-text-muted">Monitor all piracy scans across the platform</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <Card>
          ...
          <p className="text-3xl font-bold text-pg-accent">{stats.completed}</p>
        </Card>
        <Card>
          <p className="text-sm text-pg-text-muted mb-1">Pending</p>
          <p className="text-3xl font-bold text-pg-warning">{stats.pending}</p>
        </Card>
        <Card>
            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <p className="font-semibold">{scan.profiles?.email}</p>
                  <Badge
                    variant="default"
