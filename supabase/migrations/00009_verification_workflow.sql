-- Migration 00009: Verification Workflow & Deduplication System
-- Adds pending_verification workflow, URL deduplication, and time-series tracking
...
-- ============================================
-- 2. Add URL deduplication and verification fields
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_infringements_verified_date
ON infringements(product_id, date(verified_by_user_at))
WHERE verified_by_user_at IS NOT NULL;
...
-- ============================================
-- 5. Backfill existing infringements
-- ============================================

-- Generate url_hash and url_normalized for existing records
...
-- ============================================
-- 6. Create materialized view for timeline chart
-- ============================================
...
-- ============================================
-- 7. Auto-refresh materialized view trigger
-- ============================================
